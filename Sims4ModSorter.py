...
class Sims4ModSorterApp(tk.Tk):
    def __init__(self):
        ...
        # Drain any plugin boot logs after the widgets have been created.
        boot_reporter = getattr(self, "_report_mod_boot_messages", None)
        if callable(boot_reporter):
            self.after_idle(boot_reporter)
